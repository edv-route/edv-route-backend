...
| Avisos al afiliado | **Buzón transaccional + bandeja + campana** (2026-08-20): el aviso se escribe dentro de la transacción del hecho y un despachador aparte lo entrega. 15 avisos automáticos de dinero y aprobación, `GET/POST /driver-auth/me/notifications`, contador dentro de `/me/account` y campana en el header de la app. **Funciona sin push**; falta solo Firebase. Detalle en [features/notifications.md](features/notifications.md) | ✅ (falta Fase 4) |
