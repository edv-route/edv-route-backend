...
> Estado: **plan acordado, sin implementar** · Fecha: 2026-08-24 · Pedido por Luis
>
...
| Fase | Qué | Dónde |
|---|---|---|
| **1** | Tablas, ajuste configurable, endpoint de recepción y purga diaria | Backend |
| **2** | Token largo + validación del estado en el guard | Backend |
| **3** | Permisos, servicio en primer plano, cola local y arranque/parada | App |
